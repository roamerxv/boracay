...
public class FileUtil {
     ...
     * @throws NoSuchAlgorithmException
     */
    public static String getFileDigest(InputStream inputStream) throws IOException, NoSuchAlgorithmException {
     ...
     * @throws NoSuchAlgorithmException
     */
    public static String getFileDigest(File file, String digestType) throws IOException, NoSuchAlgorithmException {
     ...
     * @throws NoSuchAlgorithmException
     */
    public static String getFileDigest(InputStream inputStream, String digestType) throws IOException, NoSuchAlgorithmException {
        MessageDigest digest = MessageDigest.getInstance(digestType);
