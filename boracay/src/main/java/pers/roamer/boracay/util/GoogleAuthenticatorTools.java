...
public class GoogleAuthenticatorTools {
    ...
    public static final String SEED = "ftHZgQaZbyAPtKUFDyGYxGzQktTwnxwboeY6zkkgMamrjbFiBtGatnCbGXjARkgv";
     ...
     * @return 二维码内容
     */
    public static String getOptauth(String user, String issuer, String secret) throws UnsupportedEncodingException {
        String optauth = "otpauth://totp/%s?secret=%s&issuer=%s"; //第一个参数是显示在 app 端密码下方，表示用户名和域 。第二个参数是秘钥，第三个参数是显示在 app 端密码上方的文字。
